...
Use [`Command`](https://reference.langchain.com/python/langgraph/types/#langgraph.types.Command) to update the agent's state. This is useful for tools that need to modify conversation history or update custom state fields:
