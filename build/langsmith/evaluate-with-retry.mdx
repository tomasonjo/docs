...
## Step 1. Running the initial evaluation
...
First, we can fetch all the unsuccessful examples
```python
...
Next, we re-run all the failed examples and log them to the same experiment
```python
