...
<Tip>
**For step-by-step setup instructions for self-hosted LangSmith on AWS, GCP, or Azure**, refer to the [cloud-specific quickstart guide](/langsmith/self-hosted-cloud-quickstart).
</Tip>
